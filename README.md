...
This repository contains the C++ robot source code for FRC Team 120 from the 2021 season onward.

## Key Features

- Robot control derived from the TimedRobot class.
- An autonomous framework for configurable routines and sensor control.
- Configurable support for different drive bases, including swerve and differential.
