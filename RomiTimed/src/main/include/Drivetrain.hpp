...
///
/// @details
/// Class declaration for a drivetrain for a Romi robot.
///
...
/// @class Drivetrain
///
/// A class to interface to the drivetrain on a Romi robot.
///
////////////////////////////////////////////////////////////////
class Drivetrain
{
public:
 ...
 private:
    ...
    Spark m_LeftMotor{0};
    Spark m_RightMotor{1};

    Encoder m_LeftEncoder{4, 5};
    Encoder m_RightEncoder{6, 7};
