...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////////
    inline bool DetectPovChange(Yta::Controller::PovDirections povDirection)
    {
        bool bPressed = false;
        static bool m_LastPovChangeReported = false;
        Yta::Controller::PovDirections currentPovDirection = GetPovAsDirection();
...
private:
    ...
    Yta::Controller::PovDirections m_LastPovDirection;
...
YtaController<ControllerType>::YtaController(Yta::Controller::Config::Models controllerModel, int controllerPort) :
    ...
    m_LastPovDirection(Yta::Controller::PovDirections::POV_NOT_PRESSED),
    m_LastPovChangeReported(false)
{
}
