...
namespace SwerveConfig
{
    ...
    static constexpr const units::meter_t TRACK_WIDTH = units::meter_t(19.75 * METERS_PER_INCH);
    ...
    static constexpr const ModuleInformation FRONT_LEFT_MODULE_INFO = {"Front left", ModulePosition::FRONT_LEFT, 11, 12, 21, 237.12876_deg, CANIVORE_CAN_BUS_NAME, CANIVORE_CAN_BUS_NAME};
    static constexpr const ModuleInformation FRONT_RIGHT_MODULE_INFO = {"Front right", ModulePosition::FRONT_RIGHT, 13, 14, 22, 101.68956_deg, CANIVORE_CAN_BUS_NAME, CANIVORE_CAN_BUS_NAME};
    static constexpr const ModuleInformation BACK_LEFT_MODULE_INFO = {"Back left", ModulePosition::BACK_LEFT, 15, 16, 23, 109.59948_deg, CANIVORE_CAN_BUS_NAME, CANIVORE_CAN_BUS_NAME};
    static constexpr const ModuleInformation BACK_RIGHT_MODULE_INFO = {"Back right", ModulePosition::BACK_RIGHT, 17, 18, 24, 82.08972_deg, CANIVORE_CAN_BUS_NAME, CANIVORE_CAN_BUS_NAME};
}
